...
player_img = pygame.image.load("src/Player.jpg")
wampus_img = pygame.image.load("src/Wampus.jpg")
pit_img = pygame.image.load("src/Pit.jpg")
gold_img = pygame.image.load("src/Gold.jpg")
house_img = pygame.image.load("src/House.jpg")
